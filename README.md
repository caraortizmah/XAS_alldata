...
NOMAD parser plugin for XAS simulations output in text file.

This `nomad` plugin was generated with `Cookiecutter` along with `@nomad`'s [`cookiecutter-nomad-plugin`](https://github.com/FAIRmat-NFDI/cookiecutter-nomad-plugin) template.

This parser has 5 quantities:
From spectra:
    energy vs force oscillator strength (magnetid and electric dipole and quadrupole moments)
From eigenvectors of Davidson diagonalization (by each state):
    occupied and virtual molecular orbital indices
    probability and amplitude of the molecular orbital coupling
...
```sh
git clone https://github.com/caraortizmah/nomad-parser-xas.git
cd nomad-parser-xas
...
This parser idea in the excited-state context uses python3.9
...
```sh
pip install dist/nomad-parser-xas-0
```
...
| Name | E-mail     |
|------|------------|
| Carlos Mahecha | [caraortizmah@gmail.com](mailto:caraortizmah@gmail.com)
